...
export type CaseStage = 'registration' | 'investigation' | 'trial' | 'compensation' | 'rehabilitation' | 'witness_protection' | 'closed';
...
export type AlertType = 'intimidation_reported' | 'distress_increase' | 'missed_checkins' | 'court_approaching' | 'counselling_not_scheduled' | 'contact_failed' | 'protection_needed' | 'general';
export type InterventionType = 'counselling' | 'medical' | 'legal_aid' | 'witness_protection' | 'relocation' | 'financial_assistance' | 'rehabilitation' | 'safe_accommodation' | 'other';
...
export type UserRole = 'victim' | 'counsellor' | 'district_officer' | 'state_admin' | 'national_officer';
...
export interface TimelineEvent {
    id: string;
    caseId: string;
    eventType: 'registration' | 'check_in' | 'threat_report' | 'counselling' | 'court_date' | 'compensation' | 'intervention' | 'follow_up' | 'alert' | 'note';
    title: string;
    description: string;
    date: string;
    channel?: CheckInChannel;
