      ...
      <div className="bg-gradient-to-r from-teal-900 to-navy-950 rounded-2xl p-6 sm:p-8 text-white shadow-xs relative overflow-hidden">
        <div className="relative z-10 space-y-3 max-w-2xl">
          <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-teal-800/60 text-teal-200 text-xs font-medium border border-teal-600/40">
            ...
            <span>{isMarathi ? 'सुरक्षित आणि गोपनीय जागा' : (isMarathi || isHindi) ? 'सुरक्षित एवं गोपनीय पृष्ठ' : 'Confidential Citizen Space'}</span>
          </div>

          <h1 className="text-2xl sm:text-3xl font-bold font-serif leading-tight">
            {isMarathi ? 'नमस्कार। आम्ही तुमच्यासोबत आहोत.' : (isMarathi || isHindi) ? 'नमस्ते। हम आपके साथ हैं।' : 'You Are In A Safe Place.'}
          </h1>
          ...
          <div className="pt-2 flex flex-wrap gap-3">
            ...
            >
              ...
              <span>{isMarathi ? 'आजचे चेक-इन सुरू करा' : (isMarathi || isHindi) ? 'आज का कल्याण चेक-इन शुरू करें' : 'Start Today\'s Well-Being Check-In'}</span>
            ...
            >
              ...
              <span>{isMarathi ? 'सहाय मित्राशी बोला' : (isMarathi || isHindi) ? 'सहाय मित्र से बात करें' : 'Talk to Sahay Mitra'}</span>
            </Link>
            ...
            >
              ...
              <span>{isMarathi ? 'हेल्पलाइन 14566' : (isMarathi || isHindi) ? 'हेल्पलाइन 14566' : 'Call 14566 (Free)'}</span>
            </a>
          </div>
        </div>
      </div>
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-xl border border-stone-200 p-5 shadow-2xs space-y-4">
          <div className="flex items-center gap-2 border-b border-stone-100 pb-2">
            ...
            <h3 className="text-sm font-bold text-stone-900 font-serif">
              {isMarathi ? 'तुमची नियुक्त मदत टीम' : (isMarathi || isHindi) ? 'आपकी नियुक्त सहायता टीम' : 'Your Assigned Support Team'}
            </h3>
          </div>
        ...
        <div className="bg-white rounded-xl border border-stone-200 p-5 shadow-2xs space-y-4">
          <div className="flex items-center gap-2 border-b border-stone-100 pb-2">
            ...
            <h3 className="text-sm font-bold text-stone-900 font-serif">
              {isMarathi ? 'अलीकडील चेक-इन स्थिती' : (isMarathi || isHindi) ? 'हालिया निगरानी स्थिति' : 'Recent Check-In Status'}
            </h3>
          </div>
