...
router.post('/', authorize('district_officer', 'state_admin', 'national_officer', 'counsellor'), auditLog('CREATE_INTERVENTION', 'Intervention'), async (req, res) => {
...
router.patch('/:id', authorize('district_officer', 'state_admin', 'national_officer'), auditLog('UPDATE_INTERVENTION', 'Intervention'), async (req, res) => {
...
//# sourceMappingURL=interventions.router.js.map