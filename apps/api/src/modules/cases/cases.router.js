...
router.get('/:id', auditLog('VIEW_CASE', 'Case'), async (req, res) => {
...
router.patch('/:id', authorize('district_officer', 'state_admin', 'national_officer'), auditLog('UPDATE_CASE', 'Case'), async (req, res) => {
