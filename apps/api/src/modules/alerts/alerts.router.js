...
router.patch('/:id', authorize('district_officer', 'state_admin', 'national_officer', 'counsellor'), auditLog('UPDATE_ALERT', 'Alert'), async (req, res) => {
...
//# sourceMappingURL=alerts.router.js.map